  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Admin shell (admin_theme) — only meaningful under the admin layout.
        "sidebar-bg": channel("--c-sidebar-bg"),
        "sidebar-text": channel("--c-sidebar-text"),
        "sidebar-active-bg": channel("--c-sidebar-active-bg"),
        "sidebar-active-text": channel("--c-sidebar-active-text"),
        "sidebar-border": channel("--c-sidebar-border"),
        "brand-bar-bg": channel("--c-brand-bar-bg"),
